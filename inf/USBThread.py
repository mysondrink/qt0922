    ...
    def downLoadToUSB(self):
        ...
        if os.path.exists(save_dir):
            ...
            try:
                ...
                img_origin = cv.imread(
                    '%s/img/%s/%s-1.jpeg' % (frozen.app_path(), self.pic_path, self.name_pic))  # linux
                ...
                img_final = cv.imread(
                    '%s/img/%s/%s-2.jpeg' % (frozen.app_path(), self.pic_path, self.name_pic))  # linux
